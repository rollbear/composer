...
inline constexpr auto find_if_not
    = make_composable_function<4, back_binding>(nodiscard{
...
inline constexpr auto find_last_if_not
    = make_composable_function<4, back_binding>(
...
inline constexpr auto find_end = make_composable_function<7, back_binding>(
...
inline constexpr auto find_first_of
    = make_composable_function<7, back_binding>(nodiscard{
...
inline constexpr auto partition = make_composable_function<4, back_binding>(
    []<typename... Ts>(Ts&&... ts) -> decltype(std::ranges::partition(
                                       std::forward<Ts>(ts)...)) {
        return std::ranges::partition(std::forward<Ts>(ts)...);
    });

inline constexpr auto partition_copy
    = make_composable_function<6, back_binding>(
        []<typename... Ts>(Ts&&... ts) -> decltype(std::ranges::partition_copy(
                                           std::forward<Ts>(ts)...)) {
            return std::ranges::partition_copy(std::forward<Ts>(ts)...);
        });

inline constexpr auto stable_partition
    = make_composable_function<4, back_binding>(
        []<typename... Ts>(Ts&&... ts)
            -> decltype(std::ranges::stable_partition(
                std::forward<Ts>(ts)...)) {
...
inline constexpr auto lower_bound
    = make_composable_function<5, back_binding>(nodiscard{
...
inline constexpr auto set_union = make_composable_function<8, back_binding>(
    []<typename... Ts>(Ts&&... ts) -> decltype(std::ranges::set_union(
                                       std::forward<Ts>(ts)...)) {
        return std::ranges::set_union(std::forward<Ts>(ts)...);
    });

inline constexpr auto is_heap = make_composable_function<4, back_binding>(
...
inline constexpr auto min = make_composable_function<4, back_binding>(
...
inline constexpr auto clamp = make_composable_function<5, back_binding>(
    nodiscard{ []<typename... Ts>(Ts&&... ts) -> decltype(std::ranges::clamp(
                                                  std::forward<Ts>(ts)...)) {
        return std::ranges::clamp(std::forward<Ts>(ts)...);
    } });

inline constexpr auto sort = make_composable_function<4, back_binding>(
    []<typename... Ts>(
        Ts&&... ts) -> decltype(std::ranges::sort(std::forward<Ts>(ts)...)) {
        return std::ranges::sort(std::forward<Ts>(ts)...);
    });

inline constexpr auto partial_sort = make_composable_function<5, back_binding>(
    []<typename... Ts>(Ts&&... ts) -> decltype(std::ranges::partial_sort(
                                       std::forward<Ts>(ts)...)) {
        return std::ranges::partial_sort(std::forward<Ts>(ts)...);
    });

inline constexpr auto partial_sort_copy
    = make_composable_function<7, back_binding>(
        []<typename... Ts>(Ts&&... ts)
            -> decltype(std::ranges::partial_sort_copy(
                std::forward<Ts>(ts)...)) {
            return std::ranges::partial_sort_copy(std::forward<Ts>(ts)...);
        });

inline constexpr auto stable_sort = make_composable_function<4, back_binding>(
    []<typename... Ts>(Ts&&... ts) -> decltype(std::ranges::stable_sort(
                                       std::forward<Ts>(ts)...)) {
        return std::ranges::stable_sort(std::forward<Ts>(ts)...);
    });

inline constexpr auto nth_element = make_composable_function<4, back_binding>(
